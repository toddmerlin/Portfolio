      ...
      var he =
        ...
        (function (e) {
          ...
          function v(e) {
            for (
              ...
              if ((n = A.relative[e[s].type])) c = [f(h(c), n)];
                ...
                if (
                  ((n = A.filter[e[s].type].apply(null, e[s].matches)), n[q])
                ) {
                    ...
                    return 1 === r && 0 === a
                      ...
                      : function (t, n, l) {
                          ...
                          if (m) {
                            ...
                            if (
                              ((h = [i ? m.firstChild : m.lastChild]), i && v)
                            ) {
                              for (
                                d = m,
                                  p = d[q] || (d[q] = {}),
          ...
          return (
              ...
              function (e, t, n, r) {
                ...
                if (((n = n || []), 1 === p.length)) {
                  if (
                    ...
                    if (
                      ((t = (A.find.ID(i.matches[0].replace(xe, we), t) ||
                        [])[0]),
                      !t)
                    )
                      return n;
            ...
            (w.sortStable = q.split("").sort(Y).join("") === q),
      ...
      (ue.event = {
        ...
        fix: function (e) {
          ...
          for (
            i ||
              (this.fixHooks[a] = i =
                We.test(a) ? this.mouseHooks : Ue.test(a) ? this.keyHooks : {}),
        ...
        return (
          ...
          i.length > 0 &&
            ue
              ...
              .done(function (e) {
                (o = arguments),
                  i.html(r ? ue("<div>").append(ue.parseHTML(e)).find(r) : e);
              })
              .always(
                n &&
                  function (e, t) {
